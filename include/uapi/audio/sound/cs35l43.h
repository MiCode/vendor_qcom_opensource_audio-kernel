...
struct cs35l43_private {
	...
	//for sending dsp error to miev
	char *error_reg;
	unsigned int strm_arb_err_regval_prev;
	unsigned int strm_arb_inval_strm_regval_prev;
	unsigned int strm_arb_act_boot_regval_prev;
