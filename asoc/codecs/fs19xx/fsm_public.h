...
#include "fsm-dev.h"
#define FS19XX_CHIP_ID_REG (0x03)
#define FS1945_CHIP_ID (0x2900)
/*
 * module: fsm_regmap
 */
 ...
 * module: fsm_core
 */
fsm_config_t *fs19xx_get_config(void);
...
#define fsm_codec_name(idx)     fs19xx_get_config()->codec_name[idx]
#define fsm_codec_dai_name(idx) fs19xx_get_config()->codec_dai_name[idx]
#define fsm_get_dev_count()     fs19xx_get_config()->dev_count
