...
static int wcd937x_init_reg(struct snd_soc_component *component)
{
	...
	snd_soc_component_update_bits(component, WCD937X_MICB2_TEST_CTL_2,
				0xFF, 0x01);
	snd_soc_component_update_bits(component, WCD937X_MICB2_TEST_CTL_3,
				0xFF, 0x24);
...
#if defined(CONFIG_SND_SOC_FS1512) || defined(CONFIG_SND_SOC_SIPA)
#if defined(CONFIG_SND_SOC_FS1512)
