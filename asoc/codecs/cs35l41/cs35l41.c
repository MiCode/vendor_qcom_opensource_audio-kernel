				 ...
				 struct snd_soc_dai *dai)
{
	...
	pr_debug("cs35l41_pcm_hw_params asp_wl:%d asp_width:%d", asp_wl, asp_width);
	if ((asp_wl == 24) && (asp_width == 24)) {
		asp_width = 32;
	}
	pr_debug("cs35l41_pcm_hw_params later asp_wl:%d asp_width:%d", asp_wl, asp_width);
