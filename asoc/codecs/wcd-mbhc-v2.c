...
#include <linux/debugfs.h>
    ...
    defined(CONFIG_TARGET_PRODUCT_HOUJI) || defined(CONFIG_TARGET_PRODUCT_RUYI) || defined(CONFIG_TARGET_PRODUCT_CHENFENG) \
    || defined(CONFIG_TARGET_PRODUCT_PERIDOT) || defined(CONFIG_TARGET_PRODUCT_GOKU)
...
err:
#ifdef AUDIO_MBHC_ABNORMAL
	snprintf(reason, sizeof(reason)-1, "%s: missing qcom,msm-mbhc-hphl/gnd-swh in dt node, ret = %d", __func__, ret);
